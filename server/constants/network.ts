export default {
  ...
  INT16_SIZE: 2,
  INT8_SIZE: 1,
  // ID (Int 16) + Position x (Int 16) + Position Z (Int 16) + Level (Uint8) + Experience (Int16) + Health (Int 16) + Max Health (Int 16) + Speed (UInt 8) + Attack Range (UInt 16) + Attack Speed (UInt 16)
  BUFFER_PLAYER_SIZE: 18,
  // ID (Int 16) + Position x (Int 16) + Position Z (Int 16) + Level (Uint8) + Experience (Int16) + Health (Int 16) + Max Health (Int 16) + Speed (UInt 8) + Attack Range (UInt 16) + Attack Speed (UInt 16)
  BUFFER_ENEMY_SIZE: 18,
